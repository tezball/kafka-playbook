...
echo "=========================================="
echo "  Kafka Playbook — 04 Event Sourcing"
echo "=========================================="
echo ""
...
for name in kafka ledger-producer balance-consumer akhq; do
...
open_browser "http://localhost:8888/ui/kafka-playbook/topic/account-transactions/data?sort=NEWEST&partition=All"
...
echo "    Live Messages:   http://localhost:8888/ui/kafka-playbook/topic/account-transactions/data?sort=NEWEST&partition=All"
echo "    Consumer Groups: http://localhost:8888/ui/kafka-playbook/group"
echo ""
echo "  Transactions are being auto-generated every 10 seconds."
echo ""
echo "  Try:"
echo "    docker compose logs -f consumer                  # watch balance updates"
echo "    curl -s -X POST localhost:8080/api/transactions/sample  # send a manual transaction"
echo ""
...
docker compose logs -f --tail=50 producer consumer
