...
echo "=========================================="
echo "  Kafka Playbook — 01 Simple Pub/Sub"
echo "=========================================="
echo ""
...
for name in kafka order-producer email-consumer akhq; do
...
echo ""
echo "  Try:"
echo "    docker compose logs -f consumer          # watch email notifications"
