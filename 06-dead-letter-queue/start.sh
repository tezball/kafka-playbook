...
echo "=========================================="
echo "  Kafka Playbook — 06 Dead Letter Queue"
echo "=========================================="
echo ""
...
for name in kafka payment-producer payment-processor akhq; do
...
open_browser "http://localhost:8888/ui/kafka-playbook/topic/payments/data?sort=NEWEST&partition=All"
...
echo "    Payments:        http://localhost:8888/ui/kafka-playbook/topic/payments/data?sort=NEWEST&partition=All"
echo "    Dead Letters:    http://localhost:8888/ui/kafka-playbook/topic/payments-dlq/data?sort=NEWEST&partition=All"
echo "    Consumer Groups: http://localhost:8888/ui/kafka-playbook/group"
echo ""
echo "  Payments are being auto-generated every 10 seconds."
echo "  ~30% will exceed \$500 and land in the DLQ after 3 retries."
echo ""
echo "  Try:"
echo "    docker compose logs -f processor          # watch payment processing + DLQ"
echo "    curl -s localhost:8080/api/payments/sample # send a manual payment"
echo ""
