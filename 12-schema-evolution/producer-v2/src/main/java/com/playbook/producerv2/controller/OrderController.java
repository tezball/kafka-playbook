package com.playbook.producerv2.controller;

import com.playbook.producerv2.service.OrderProducerService;
import com.playbook.producerv2.service.SampleDataGenerator;
...
public class OrderController {
    ...
    public ResponseEntity<Map<String, String>> createSampleOrder() {
        ...
        return ResponseEntity.status(HttpStatus.ACCEPTED)
                .body(Map.of("orderId", event.orderId(), "version", "v2", "status", "ACCEPTED"));
    }
}
